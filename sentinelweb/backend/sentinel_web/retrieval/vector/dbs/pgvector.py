...
from sentinel_web.retrieval.vector.main import VectorItem, SearchResult, GetResult
from sentinel_web.config import PGVECTOR_DB_URL, PGVECTOR_INITIALIZE_MAX_VECTOR_LENGTH
...
class PgvectorClient:
    def __init__(self) -> None:
        ...
        if not PGVECTOR_DB_URL:
            from sentinel_web.internal.db import Session
