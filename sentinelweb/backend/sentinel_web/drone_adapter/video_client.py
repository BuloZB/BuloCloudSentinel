"""
Video Client for SentinelWeb

This module provides a client for interacting with BuloCloudSentinel's video API.
"""
...
class VideoClient:
    ...
    This class provides methods for interacting with BuloCloudSentinel's video API.
    """
