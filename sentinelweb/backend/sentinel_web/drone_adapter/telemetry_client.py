"""
Telemetry Client for SentinelWeb

This module provides a client for interacting with BuloCloudSentinel's telemetry API.
"""
...
class TelemetryClient:
    """
    Client for telemetry operations.
    
    This class provides methods for interacting with BuloCloudSentinel's telemetry API.
    """
