...
from sentinel_web.env import ENV, SRC_LOG_LEVELS


from sentinel_web.utils.payload import (
        ...
        async with aiohttp.ClientSession(timeout=timeout, trust_env=True) as session:
            async with session.get(
                ...
                headers={
                    ...
                    **(
                        {
                            "X-SentinelWeb-User-Name": user.name,
                            "X-SentinelWeb-User-Id": user.id,
                            "X-SentinelWeb-User-Email": user.email,
                            "X-SentinelWeb-User-Role": user.role,
                        }
        ...
        try:
            r = requests.post(
                ...
                headers={
                    ...
                    **(
                        {
                            "HTTP-Referer": "https://SentinelWeb.com/",
                            "X-Title": "Open WebUI",
                        }
