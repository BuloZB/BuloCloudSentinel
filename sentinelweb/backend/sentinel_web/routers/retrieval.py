...
from sentinel_web.models.files import FileModel, Files
from sentinel_web.models.knowledge import Knowledges
from sentinel_web.storage.provider import Storage


from sentinel_web.retrieval.vector.connector import VECTOR_DB_CLIENT

# Document loaders
from sentinel_web.retrieval.loaders.main import Loader
from sentinel_web.retrieval.loaders.youtube import YoutubeLoader

# Web search engines
from sentinel_web.retrieval.web.main import SearchResult
from sentinel_web.retrieval.web.utils import get_web_loader
from sentinel_web.retrieval.web.brave import search_brave
from sentinel_web.retrieval.web.kagi import search_kagi
from sentinel_web.retrieval.web.mojeek import search_mojeek
from sentinel_web.retrieval.web.bocha import search_bocha
from sentinel_web.retrieval.web.duckduckgo import search_duckduckgo
from sentinel_web.retrieval.web.google_pse import search_google_pse
from sentinel_web.retrieval.web.jina_search import search_jina
from sentinel_web.retrieval.web.searchapi import search_searchapi
from sentinel_web.retrieval.web.serpapi import search_serpapi
from sentinel_web.retrieval.web.searxng import search_searxng
from sentinel_web.retrieval.web.serper import search_serper
from sentinel_web.retrieval.web.serply import search_serply
from sentinel_web.retrieval.web.serpstack import search_serpstack
from sentinel_web.retrieval.web.tavily import search_tavily
from sentinel_web.retrieval.web.bing import search_bing
from sentinel_web.retrieval.web.exa import search_exa
from sentinel_web.retrieval.web.perplexity import search_perplexity
from sentinel_web.retrieval.web.sougou import search_sougou

from sentinel_web.retrieval.utils import (
...
from sentinel_web.utils.misc import (
    calculate_sha256_string,
)
from sentinel_web.utils.auth import get_admin_user, get_verified_user

from sentinel_web.config import (
    ENV,
...
from sentinel_web.env import (
    SRC_LOG_LEVELS,
    DEVICE_TYPE,
    DOCKER,
)
from sentinel_web.constants import ERROR_MESSAGES
...
def get_rf(
    ...
    if reranking_model:
        if any(model in reranking_model for model in ["jinaai/jina-colbert-v2"]):
            try:
                from sentinel_web.retrieval.models.colbert import ColBERT
