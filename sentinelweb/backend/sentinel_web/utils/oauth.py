...
from sentinel_web.models.auths import Auths
from sentinel_web.models.users import Users
from sentinel_web.models.groups import Groups, GroupModel, GroupUpdateForm
...
from sentinel_web.constants import ERROR_MESSAGES, WEBHOOK_MESSAGES
from sentinel_web.env import (
    WEBUI_NAME,
    WEBUI_AUTH_COOKIE_SAME_SITE,
    WEBUI_AUTH_COOKIE_SECURE,
)
from sentinel_web.utils.misc import parse_duration
from sentinel_web.utils.auth import get_password_hash, create_token
from sentinel_web.utils.webhook import post_webhook

from sentinel_web.env import SRC_LOG_LEVELS, GLOBAL_LOG_LEVEL
...
class OAuthManager:
    ...
    def update_user_groups(self, user, user_data, default_permissions):
        ...
        log.debug(
            f"All groups available in SentinelWeb: {[g.name for g in all_available_groups]}"
        )
