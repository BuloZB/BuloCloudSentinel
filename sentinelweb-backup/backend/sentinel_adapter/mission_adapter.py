...
This module adapts OpenWebUI's chat/conversation handling to work with drone missions.
It maps OpenWebUI's conversation concepts to mission concepts.
"""
...
class MissionAdapter:
    ...
    This class adapts OpenWebUI's conversation operations to work with missions.
    It maps conversation concepts to mission concepts:
    - Conversations -> Missions
    - Messages -> Waypoints
    - Chat settings -> Mission parameters
    """
    ...
    async def list_missions(
        ...
        This method adapts OpenWebUI's list_conversations to list missions.
    ...
    async def get_mission(self, mission_id: str) -> Optional[Mission]:
        ...
        This method adapts OpenWebUI's get_conversation to get mission details.
    ...
    async def create_mission(self, mission_data: Dict[str, Any]) -> Optional[Mission]:
        ...
        This method adapts OpenWebUI's create_conversation to create missions.
    ...
    async def update_mission(self, mission_id: str, mission_data: Dict[str, Any]) -> Optional[Mission]:
        ...
        This method adapts OpenWebUI's update_conversation to update missions.
    ...
    async def delete_mission(self, mission_id: str) -> bool:
        ...
        This method adapts OpenWebUI's delete_conversation to delete missions.
    ...
    async def execute_mission(self, mission_id: str) -> Dict[str, Any]:
        ...
        This method adapts OpenWebUI's generate_title to execute missions.
    ...
    async def simulate_mission(self, mission_id: str) -> Dict[str, Any]:
        ...
        This method adapts OpenWebUI's generate_title to simulate missions.
    ...
    async def import_mission(self, file_content: bytes, file_format: str, name: str) -> Optional[Mission]:
        ...
        This method adapts OpenWebUI's import_conversation to import missions.
    ...
    async def export_mission(self, mission_id: str, export_format: str) -> Optional[bytes]:
        ...
        This method adapts OpenWebUI's export_conversation to export missions.
