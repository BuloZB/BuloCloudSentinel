    ...
    if files := body.get("metadata", {}).get("files", None):
        ...
        try:
            ...
            try:
                ...
                log.warning(f"Error parsing queries response JSON: {e}")
                queries_response = {"queries": [queries_response]}

            queries = queries_response.get("queries", [])
        except Exception as e:
            log.warning(f"Error processing queries: {e}")
            # Set queries to empty list to continue processing
            queries = []
        ...
        try:
            ...
            log.exception(f"Error getting sources from files: {e}")
            # Set sources to empty list to continue processing
            sources = []
                ...
                if TASKS.TAGS_GENERATION in tasks and tasks[TASKS.TAGS_GENERATION]:
                    ...
                    if res and isinstance(res, dict):
                        ...
                        try:
                            ...
                            log.warning(f"Error processing tags: {e}")
