...
def safe_load_model(file_path: str, model_type: str = None) -> Any:
    ...
    try:
        ...
        if model_type == "pytorch":
            ...
            # Check if the model is from a trusted source
            # This is a simple check based on file path, you may want to implement
            # more sophisticated checks based on your security requirements
            trusted_dirs = [
                os.path.join(os.path.dirname(__file__), "models"),
                os.path.join(os.path.dirname(os.path.dirname(__file__)), "models"),
                # Add other trusted directories here
            ]

            is_trusted = any(os.path.abspath(file_path).startswith(os.path.abspath(trusted_dir))
